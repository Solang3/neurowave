    ...
    return (
      <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-4">
        ...
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="font-serif text-3xl mb-3">Revisá tu email</h1>
          <p className="text-muted text-sm leading-relaxed mb-6">
            Te enviamos un link de confirmación a <strong className="text-white">{email}</strong>. 
            Clickealo para activar tu cuenta.
          </p>
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm">
        <h1 className="font-serif text-3xl mb-2">Crear cuenta</h1>
        <p className="text-muted text-sm mb-8">Empezá gratis, sin tarjeta de crédito</p>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          ...
          <div>
            <label className="text-xs text-muted mb-1.5 block">Confirmá la contraseña</label>
            <input
              type="password"
              value={confirm}
