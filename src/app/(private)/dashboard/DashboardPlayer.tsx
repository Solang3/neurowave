...
const WAVE_GROUPS = [
  {
    ...
    tracks: [
      ...
      { id: 'delta-nature-tormenta-va', genre: 'Nature', emoji: '🌿', path: 'delta/nature/Delta-nature-La Tormenta se Va-binaural.mp3' },
      { id: 'delta-nature-tormenta', genre: 'Nature', emoji: '🌿', path: 'delta/nature/Delta-nature-La Tormenta-binaural.mp3' },
      { id: 'delta-nature', genre: 'Nature', emoji: '🌿', path: 'delta/nature/Delta-nature-Regreso al Amanecer-binaural.mp3' },
